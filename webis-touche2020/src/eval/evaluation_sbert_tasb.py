...
# data_path = f"/store2/scratch/n3thakur/touche-ablations/touche-title-text-old-new-annotations"
data_path = f"/store2/scratch/n3thakur/beir-datasets/final/webis-touche2020-wo-title"
...
# with open(f"webis-touche2020-more-than-{words}-words.jsonl", 'w', encoding="utf-8") as fOut:
#     for idx, meta in corpus.items():
#         json.dump({
#             "_id": idx, 
...
output_dir = os.path.join('/store2/scratch/n3thakur/touche-ablations/output', 'tas-b', 'original_touche2020_wo_title')
